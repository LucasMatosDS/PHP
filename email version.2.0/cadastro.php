...
<input id="campo" type="text"  name="email" placeholder="Informe o E-mail do Destinatário:" autofocus class="form-control" pattern="^([0-9a-zA-Z]+([_.-]?[0-9a-zA-Z]+)*@[0-9a-zA-Z]+[0-9,a-z,A-Z,.,-]*(.){1}[a-zA-Z]{2,4})+$" required> 
 ...
 <div class="form-group col-md-12">
<input id="campo" type="text"  name="emailusu" placeholder="Informe o seu E-mail:" autofocus class="form-control" pattern="^([0-9a-zA-Z]+([_.-]?[0-9a-zA-Z]+)*@[0-9a-zA-Z]+[0-9,a-z,A-Z,.,-]*(.){1}[a-zA-Z]{2,4})+$" required> 
</div>
<div class="form-group col-md-12">
<input id="campo" type="text" name="nome" placeholder="Digite seu nome: " class="form-control"  required>
</div>
<div class="form-group col-md-12">
<input id="campo" type="text" name="telefone" placeholder="Informe o seu telefone: " class="form-control"  required>
</div>
<div class="form-group col-md-12">
